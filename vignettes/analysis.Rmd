...
At first glance, it appears that the peak of India coverage came around 2012-2014. However, the shift to (and later shift away from) blogging complicates this understanding. The NYT [India Ink blog](https://india.blogs.nytimes.com) ran from September 2011 to June 2014. 
...
```{r timeline_printed, out.width = "90%"}
```

The closest apples-to-apples comparison is to restrict the pool of articles to front page news. In addition, for the numbers below, I removed articles that include "World Business Briefing" in the headline, which was a short roundup of business stories from around the world that commonly landed on the front page during some years-- not exactly big India stories. 
...
```{r timeline_front_page, out.width = "90%"}
```
...
```{r location_counts, out.width = "90%"}
```
